...
function! kronos#sync#common#init()
  try
    ...
    return kronos#utils#log#error('Kronos sync: missing option +channel.')
  catch 'job'
    return kronos#utils#log#error('Kronos sync: missing option +job.')
  catch 'version'
    return kronos#utils#log#error('Kronos sync: missing vim8+.')
  catch
    return kronos#utils#log#error('Kronos sync: init failed.')
  endtry
