...
syntax match kronos_info_last_active /\(|.*\)\@<=|.*|\%6l/ contains=kronos_info_separator
syntax match kronos_info_due         /\(|.*\)\@<=|.*|\%7l/ contains=kronos_info_separator
syntax match kronos_info_worktime    /\(|.*\)\@<=|.*|\%8l/ contains=kronos_info_separator
syntax match kronos_info_done        /\(|.*\)\@<=|.*|\%9l/ contains=kronos_info_separator
...
highlight default link kronos_info_last_active String
